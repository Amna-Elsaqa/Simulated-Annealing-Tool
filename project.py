...
Original file is located at
    https://colab.research.google.com/drive/1XWMcSDfOtU0xbMxJ5zLLVI0fAL2lOL_a
...
*  The number of columns/sites per row (nx)
...
*   Next Temperature = 0.95 x Current Temperature  **NOTE: 0.95 is the cooling rate**
...
def swap_cells(num_cells, num_rows, num_cols, grid, cell_positions, cell_1, cell_2):
  ...
  # new_x_cell_1 = new_cell_positions[cell_1][1]
  # new_y_cell_1 = new_cell_positions[cell_1][2]
  # new_x_cell_2 = new_cell_positions[cell_2][1]
  # new_y_cell_2 = new_cell_positions[cell_1][2]
